    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(getArguments() != null){
            ...
            if(bloodtype.equals("Select Blood Type") && region.equals("Select Region")){
                ...
                ref = childRef.orderByChild("privacy").equalTo(true).orderByChild("region").equalTo(region);
            }
            else if(region.equals("Select Region")){
                ref = childRef.orderByChild("privacy").equalTo(true).orderByChild("bloodtype").equalTo(bloodtype);
            }
            else{
                ref = childRef.orderByChild("privacy").equalTo(true).orderByChild("region")
                        .equalTo(region).orderByChild("bloodtype").equalTo(bloodtype);
            }
