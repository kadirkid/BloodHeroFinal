...
public class SignUpFragment extends Fragment implements View.OnClickListener {
    ...
    private void signup() {
        ...
        String blood = bloodTypeSpinner.getSelectedItem().toString();
        String country_str = countrySpinner.getSelectedItem().toString();

        user = new User(namestr, passwordstr, emailstr, blood, null, country_str);
